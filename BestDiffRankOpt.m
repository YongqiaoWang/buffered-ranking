function [Rank,RunTime,vOptNu,vOptMu]=BestDiffRankOpt(mInput,mOutput,iDMUo,params)
%Aim
%Estimate the best ranking of the difference-based efficiency of iDMUo among DMUs (mInput,mOutput)
